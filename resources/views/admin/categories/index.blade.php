                    ...
                    <tr class="hover:bg-sage-50/50 transition">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-2">
                                <a href="{{ route('admin.categories.edit', $category) }}" class="text-sage-600 hover:text-sage-800 transition p-1" aria-label="Edit">
                                ...
                                <button type="button" class="delete-category-btn text-red-500 hover:text-red-700 transition p-1" data-id="{{ $category->id }}" data-name="{{ $category->name }}">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
