...
<div class="flex min-h-screen relative">
    ...
    <main class="main-content flex-1 min-h-screen flex flex-col">
        <!-- Header (tanpa tombol toggle) -->
        <header class="sticky top-0 z-50 bg-white/90 backdrop-blur-xl border-b border-slate-200 h-16 px-6 lg:px-8 flex items-center justify-between shrink-0">
            <!-- Search (tetap ada) -->
            <div class="flex items-center gap-4">
                <div class="relative hidden md:block">
                    ...
                    <input type="search"
                           id="global-search"
                           placeholder="Cari..."
                           class="w-80 h-10 rounded-xl border border-slate-200 bg-slate-50 px-4 pl-10 text-sm focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition"
                           autocomplete="off">
