                    ...
                    <tr class="hover:bg-sage-50/50 transition">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-2">
                                <a href="{{ route('admin.products.edit', $product) }}" class="text-sage-500 hover:text-sage-700 p-1.5 rounded-md hover:bg-sage-100 transition bg-transparent" aria-label="Edit">
                                ...
                                <button type="button" class="text-red-500 hover:text-red-700 p-1.5 rounded-md hover:bg-red-100 transition bg-transparent" data-id="{{ $product->id }}" data-name="{{ $product->name }}">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
